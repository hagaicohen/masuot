...
def main():
    ...
    rules_data.extend([
        ...
        ("health_total", to_num(row[37].value), "health"),

        ("health_0_50", to_num(row[38].value), "health"),

        ("health_50_70", to_num(row[39].value), "health"),

        ("health_70_plus", to_num(row[40].value), "health")
    ])
